          ...
          {[
            {
              ...
              text: "It was first game that i created. It teached me basics of C# and how Unity works.",
            },
            {
              gif: "gra2.gif",
              title: "Project 2 – Tetris",
              text: "Tetris was the first game of this complexity. Just figuring out how to approach it burned through many nerves and hours.",
            },
            {
              gif: "gra3.gif",
              title: "Project 3 – Ladder Climber",
              text: "One of the most enjoyable projects that allowed me to add whatever I wanted to the game and test various ideas that wouldn't normally have a place anywhere else.",
            },
            {
              gif: "gra4.gif",
              title: "Project 4 – RougeLike Game",
              text: "Unfortunately, this project was buried by overambition. However, it's the most advanced I've created to date. It includes a working room generation system with a multitude of modular parameters. It also has a working shooting system, dialogue, inventory, and level movement system, as well as a player tracking system and enemy patrols.",
            },
          ].map((project, index) => (
            <motion.div
              key={index}
            ...
            >
              ...
              <div
                className={`order-2 ${index % 2 === 1 ? "md:order-1" : "md:order-2"} space-y-6 text-center md:text-left`}
              >
